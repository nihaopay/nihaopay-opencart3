...
class ControllerExtensionPaymentNihaoPayOnlineWechatPay extends Controller {
	public function index() {
		...
		return $this->load->view('extension/payment/nihaopay_online_wechatpay', '');
	}

	public function send() {
	    $url = 'https://api.nihaopay.com/v1.2/transactions/securepay';
	    if ($this->config->get('payment_nihaopay_online_wechatpay_server') == 'test') {
...
// 		    CURLOPT_URL => $url,
	...
	public function callback() {
	    ...
	    $this->load->model('extension/payment/nihaopay_online_wechatpay');
