...
class ControllerExtensionPaymentNihaoPayOnlineAliPay extends Controller {
	...
	public function send() {
	    ...
	    if ($this->config->get('payment_nihaopay_online_alipay_server') == 'test') {
		...
		$data['callback_url'] = $this->url->link('extension/payment/nihaopay_online_alipay/callback', '', true);
		$data['ipn_url'] = $this->url->link('extension/payment/nihaopay_online_alipay/ipn', '', true);
...
// 		    CURLOPT_URL => $url,
	...
	public function callback() {
	    ...
	    $this->load->model('extension/payment/nihaopay_online_alipay');
